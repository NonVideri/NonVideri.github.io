...
export default function Form(props) {
  ...
  <form type='range' onSubmit={handleSubmit}>
    <div className="input-group">
      ...
      <textarea id='custom' className="form-control" hidden={modes.numberRange} type='text' placeholder='Enter items here' onChange={handleChange}/>
      <input id='number1' className="form-control" hidden={!modes.numberRange} type='number' placeholder='0' max='9999' onChange={handleChange}/>
      <input id='number2' className="form-control" hidden={!modes.numberRange} type='number' placeholder='0' max='9999' onChange={handleChange}/>
    </div>
