...
export default function Randomizer() {
  ...
  const itemSound = new Audio(
    'https://dl.dropboxusercontent.com/s/e85v3w9rv9yr38t/item.wav'
  );
  // Mode select
  ...
  return (
    ...
    <div>
      ...
      <button
        ...
        hidden={mode.submitted}
        onClick={() => toggleMode('numberRange')}
      >
